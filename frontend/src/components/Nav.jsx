  ...
  return (
    <>
      {selectedConversation && (
        <div className="h-14 flex items-center justify-between pl-14 pr-5 md:px-5 absolute top-0 left-0 right-0 z-10 bg-linear-to-b from-[#0d0d0d] via-[#0d0d0d]/80 to-transparent">
          {/* Left Section */}
